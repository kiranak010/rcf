...
export default function NavigationAdminPage() {
  ...
  useEffect(() => {
    setItems([
      { id: '1', label: 'Home', href: '/', order: 1, status: 'published' },
      { id: '2', label: 'About Us', href: '/about', order: 2, status: 'published' },
      { id: '3', label: 'Products', href: '/products', order: 3, status: 'published' },
    ])
  }, [])
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage site navigation and menus.</p>
        </div>
        <Link href="/admin/navigation/new" className="btn-primary">
              ...
              <tr key={item.id}>
                ...
                <td className="px-6 py-4 text-right text-sm">
                  <div className="flex items-center justify-end gap-2">
                    <Link href={`/admin/navigation/${item.id}`} className="text-primary hover:text-primary/80">
